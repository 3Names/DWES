...
class TareasController {
	...
	if (!ACL::puede('tareas.terminar')) {
            $_SESSION['error'] = "No tienes permisos para terminar tareas";
            header("Location: index.php");
            exit;
        }
	$_SESSION['mensaje'] = "Tareas iniciadas finalizadas";
	$model = new TareasModel();
	$tareas = $model->endTareas();
	header("Location: index.php");
	require "views/tareas_listado.php";
    }
}
