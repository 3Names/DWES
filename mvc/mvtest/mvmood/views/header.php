...
<body>
    ...
    <div class="container">
        ...
        <!-- Sidebar -->
        <div class="sidebar">
            <a href="publicaciones_listado.php" class="<?= (basename($_SERVER['PHP_SELF']) === 'home.php') ? 'active' : '' ?>">Home</a>
            ...
            <a href="views/publicaciones_crear.php" class="<?= (basename($_SERVER['PHP_SELF']) === 'create.php') ? 'active' : '' ?>">Create</a>
            <a href="#">Language</a>
            <a href="#">Theme</a>
